...
<body>
        ...
        <div class="container"> <a class="navbar-brand" href="#" style="font-size:30px;">
          ...
          <div class="collapse navbar-collapse" id="navbar16">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item mx-2"> <a href="<?php echo base_url(); ?>Keuangan/welcome_page_keuangan" class="nav-link d-inline-flex justify-content-center align-items-center text-light text-center"><i class="fa fa-fw fa-home fa-2x" style="color:white;"></i>HOME</a> </li>
  ...
  <div class="">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo base_url(); ?>Keuangan/kelolaPengeluaran" ><button class="btn mx-1 btn-primary" type="button" style="border-radius:20px;">Kelola Pengeluaran</button></a>
        </div>
        <div class="col-md-3">
          <a href="<?php echo base_url(); ?>Keuangan/ViewPemesanan" ><button class="btn mx-1 btn-primary" type="button" style="border-radius:20px;">Edit Pemesanan</button></a>
        </div>
        <div class="col-md-3">
          <a href="<?php echo base_url(); ?>Keuangan/ViewKaryawan" ><button class="btn mx-1 btn-primary" type="button" style="border-radius:20px;">View Karyawan</button></a>
        </div>
      </div>
    </div>
  </div>
