...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/jq-3.3.1/dt-1.10.18/r-2.2.2/sc-1.5.0/datatables.min.css"/>
  <script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jq-3.3.1/dt-1.10.18/r-2.2.2/sc-1.5.0/datatables.min.js"></script>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 shadow-none">
          <table id="pesanan-table" class="table shadow table-bordered table-responsive" style="margin:auto;background-color: rgba(64, 147, 194, 0.8); border-radius:10px;color:white">
            <thead>
              <tr>
