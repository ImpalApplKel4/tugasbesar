    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 shadow-none">
          <table id="bahan-table" class="table shadow table-bordered responsive" style="margin:auto;background-color: rgba(64, 147, 194, 0.8); border-radius:10px;color:white">
            <thead>
              <tr>
