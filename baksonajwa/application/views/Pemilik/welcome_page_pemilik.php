...
<nav class="navbar navbar-expand-md navbar-dark bg-primary py-1" style="background-color: #4093C2;">
  ...
  <div class="p-2">
    <div class="container mt-5">
      ...
      <p class="welcome" style="margin-top: 20px;"> Pemilik bertugas untuk mengelola data karyawan dan melihat aktivitas yang dilakukan pada sistem pencatatan Baso Najwa. Apa yang ingin anda lakukan hari ini ?</p>
    </div>
  </div>
  <div class="">
    <div class="container">
      <div class="row">
        <div class="col-md-2">
          <a href="<?php echo base_url(); ?>Pemilik/kelolaKaryawan" ><button class="btn mx-1 btn-primary" type="button" style="border-radius:20px;">Kelola Karyawan</button></a>
        </div>
        <div class="col-md-2">
          <a href="<?php echo base_url(); ?>Pemilik/ViewPemesanan"><button class="btn mx-1 btn-primary" type="button" style="border-radius:20px;">View Pemesanan</button></a>
        </div>
        <div class="col-md-2">
          <a href="<?php echo base_url(); ?>Pemilik/ViewBahan"><button class="btn mx-1 btn-primary" type="button" style="border-radius:20px;">View Bahan</button></a>
        </div>
        <div class="col-md-2">
          <a href="<?php echo base_url(); ?>Pemilik/ViewProduk"><button class="btn mx-1 btn-primary" type="button" style="border-radius:20px;">View Produk</button></a>
        </div>
        <div class="col-md-2">
          <a href="<?php echo base_url(); ?>Pemilik/ViewPengeluaran"><button class="btn mx-1 btn-primary" type="button" style="border-radius:20px;">View Pengeluaran</button></a>
        </div>
      </div>
    </div>
  </div>
